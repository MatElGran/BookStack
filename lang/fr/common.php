...
return [
  ...
  "cover_image_description" => "Cette image doit être d’environ 440x250px, bien qu’elle soit redimensionnée et recadrée de manière flexible pour s’adapter à l’interface utilisateur dans différents scénarios, selon les besoins. Les dimensions réelles d’affichage peuvent donc différer.",
  "actions" => "Actions",
  "view" => "Afficher",
  ...
  "sort_direction_toggle" => "Inverser le sens de tri",
